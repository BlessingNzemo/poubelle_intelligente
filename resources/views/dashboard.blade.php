...
<!-- Main Content -->
<div class="ml-64 p-8 bg-gray-900" x-data="{ addBinModalOpen: false }">
    <!-- Header -->
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Gestion des Poubelles Connectées</h1>
        <button onclick="toggleModal()" class="bg-green-600 text-white px-4 py-2 rounded-lg flex items-center">
