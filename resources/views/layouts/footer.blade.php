<footer class="bg-white dark:bg-gray-800">
    <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
            <div>
                <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Notre Solution</h3>
                <ul class="text-gray-500 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="#" class="hover:underline">À propos</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Technologies</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Partenaires</a>
                    </li>
                    <li class="mb-4">
            ...
            <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Guide d'utilisation</a>
                    </li>
                    <li class="mb-4">
            ...
            <div>
                <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Légal</h3>
                <ul class="text-gray-500 dark:text-gray-400">
                    <li class="mb-4">
            ...
            <div>
                <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Application</h3>
                <ul class="text-gray-500 dark:text-gray-400">
                    <li class="mb-4">
                    ...
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Tableau de bord web</a>
                    </li>
                </ul>
            </div>
        </div>
